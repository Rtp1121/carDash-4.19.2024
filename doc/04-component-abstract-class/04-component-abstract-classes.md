...
I have removed the 'resetAll()' secondary method as it has the same exact functionality as just making an new carDash object.
I am trying to make a Map<String, double> as a class variable to store all the values needed for a carDash but am unsure how to.
