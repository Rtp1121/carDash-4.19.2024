...
I believe that I have a better understanding of software development because I
was finally able to code something completely from scratch and something that I
could actually use in the real world especially going into the automotive
industry.

> Also, did the portfolio project surface any gaps in your own knowledge of
> software development. If so, what are those gaps and how did you address them?

It addressed my gaps of how components work because this was a confusing topic
for me. I didn't truly understand how components work until I made one myself,
and now things make so much more sense. I addressed my gaps by going through
previous assignments, labs, and projects along with doing research online and
...
After completing my portfolio project, I've come to realize that I actually enjoy
personal projects, but that OSU has killed my passion for CSE. I'm now switching
majors to ECE as I realize that I do enjoy software, but I also need to be hands-on,
so I think that ECE is a good fit for me. All in all, I'm very grateful
to have been given this opportunity to develop something on my own and realize
that it's still possible to enjoy CS and I hope to utilize CS skills in my career.
...
The skills I picked up through this process other than software skills are utilizing
my resources. I became much more efficient at looking through previous assignments,
labs, and projects while finding online resources such as GeeksforGeeks, Stack
Overflow, and the Oracle Help Center.
...
This project has affected my career trajectory in a positive way. I wanted to go
into the automotive industry and I feel like this step has gotten me one step
closer to what it could be like and I hope to continue down this path.
...
Some things I could do to continue on my career trajectory are to find coding
projects in C/C++ because that's the industry standard for the automotive industry.
I could also find ways to practice engine tuning and utilizing automotive software.
I could also mess with rasberry pi to make my digital car dash idea to reality.
