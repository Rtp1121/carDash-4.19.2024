...
I plan on using Map because it works the best when it comes to storing all the
necessary information for a car dash. Each key can be a String that represents a
certain piece of necessary information while the value can be the corresponding
value of the piece of information such as "fuel level" and its numerical value.
