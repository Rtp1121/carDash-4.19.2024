...
After reading your feedback, I understood that my classes were repetitive and
having several of them would make interfacing difficult, so I was able to
simplify much of my code into just a couple of methods. I am still unsure if my
thinking is correct or not but I plan to make changes accordingly if needed.
